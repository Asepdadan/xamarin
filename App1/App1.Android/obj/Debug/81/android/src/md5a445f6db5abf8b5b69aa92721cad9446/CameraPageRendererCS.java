...
public class CameraPageRendererCS
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.Droid.CameraPageRendererCS, App1.Android", CameraPageRendererCS.class, __md_methods);
	}


	public CameraPageRendererCS (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == CameraPageRendererCS.class)
			mono.android.TypeManager.Activate ("App1.Droid.CameraPageRendererCS, App1.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public CameraPageRendererCS (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CameraPageRendererCS.class)
			mono.android.TypeManager.Activate ("App1.Droid.CameraPageRendererCS, App1.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public CameraPageRendererCS (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CameraPageRendererCS.class)
			mono.android.TypeManager.Activate ("App1.Droid.CameraPageRendererCS, App1.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
